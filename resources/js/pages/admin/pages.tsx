...
export default function PagesList({ pages }: PagesProps) {
  ...
  const columns = [
    {
      header: 'Title (EN)',
      accessor: (p: PageItem) => getTranslation(p.title, 'en'),
    },
    {
      header: 'Slug',
      accessor: (p: PageItem) => p.slug,
    },
    {
      header: 'Status',
      accessor: (p: PageItem) => (
    ...
    {
      header: 'Created At',
      accessor: (p: PageItem) => new Date(p.created_at).toLocaleDateString(),
    },
    {
      header: 'Actions',
      accessor: (p: PageItem) => (
      ...
      <div className="p-6 space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-neutral-500">Create and edit static pages for your application.</p>
          </div>
          <button
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
            <div className="w-full max-w-3xl rounded-xl border border-sidebar-border/70 bg-white p-6 shadow-xl dark:bg-neutral-900 max-h-[90vh] overflow-y-auto">
              <h2 className="text-lg font-bold mb-4">{editingPage ? 'Edit Page' : 'Create New Page'}</h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <RichTextEditor value={data.content_en} onChange={(val) => setData('content_en', val)} placeholder="Write page content in English..." />
                ...
                <div>
                  ...
                  <RichTextEditor value={data.content_es} onChange={(val) => setData('content_es', val)} placeholder="Escribe el contenido de la página en Español..." />
                </div>
